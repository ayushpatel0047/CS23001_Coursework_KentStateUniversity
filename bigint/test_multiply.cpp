...
int main() {
...

    {
        //------------------------------------------------------
        Bigint left("1");
        Bigint right("999999999999999999999999999999999999999999999999");
        Bigint result;

        result = left * right;

        assert(left == "1");
        assert(right == "999999999999999999999999999999999999999999999999");
        assert(result == "999999999999999999999999999999999999999999999999");
    }

    {
        //------------------------------------------------------
        Bigint left("1000000000000000000000000");
        Bigint right("1000000000000000000000");
        Bigint result;

        result = left * right;

        assert(left == "1000000000000000000000000");
        assert(right == "1000000000000000000000");
        assert(result == "1000000000000000000000000000000000000000000000");
    }
